...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__topup__ = __webpack_require__(817);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__menus__ = __webpack_require__(786);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TopupPage = /** @class */ (function () {
    function TopupPage(contactsProvider, alertService, clientdata, navCtrl, globalVars, navParams) {
        ...
        this.utilities = [];
        this.utilities = __WEBPACK_IMPORTED_MODULE_6__menus__["a" /* airtime */];
    ...
    TopupPage.prototype.goHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    TopupPage.prototype.ionViewDidEnter = function () {
        this.globalVars.reload();
    };
    TopupPage.prototype.openPage = function (mypage) {
        this.navCtrl.push('AirtimePage', {
            data: mypage
        });
    };
    TopupPage.prototype.getItems = function (ev) {
        ...
        if (val && val.trim() != '') {
            ...
            this.utilities = this.globalVars.allData.topup;
        }
    };
    TopupPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    TopupPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-topup',template:/*ion-inline-start:"E:\Eclectics projects\PBZ\pbz_mobile_appApril\src\pages\topup\topup.html"*/'<!-- <ion-header>\n\n    <ion-navbar color="primary">\n        <ion-title> {{langs.airtime_topup}}</ion-title>\n        <ion-buttons right (click)="goHome()">\n            <button ion-button icon-only color="white">\n                <ion-icon name="home"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header> -->\n<ion-content >\n\n        <ion-navbar color="primary">\n                <ion-title> {{langs.airtime_topup}}</ion-title>\n                <ion-buttons right (click)="goHome()">\n                    <button ion-button icon-only color="white">\n                        <ion-icon name="home"></ion-icon>\n                    </button>\n                </ion-buttons>\n            </ion-navbar>\n\n\n    <div style="padding:0.9vh;font-size:1.8vh"> {{langs.airtime_topup}} </div>\n    <ion-row text-center style="color:#333">\n        <ion-col col-4 no-padding *ngFor="let utility of utilities;let i=index" (click)="openPage(utility)">\n            <div class="outer">\n                <div style=" display:flex;margin:auto;height:6vh;width:6vh;">\n                    <img src="{{utility.icon}}" style="border-radius:50%" /> </div>\n                <p class="para">\n                    {{utility.title}}</p>\n            </div>\n        </ion-col>\n    </ion-row>\n</ion-content>'/*ion-inline-end:"E:\Eclectics projects\PBZ\pbz_mobile_appApril\src\pages\topup\topup.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__providers_contacts_contacts__["a" /* ContactsProvider */], __WEBPACK_IMPORTED_MODULE_3__providers_alert_service_alert_service__["a" /* AlertServiceProvider */], __WEBPACK_IMPORTED_MODULE_4__providers_clientdata_clientdata__["a" /* ClientdataProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_global_vars_global_vars__["a" /* GlobalVarsProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */]])
    ], TopupPage);
    return TopupPage;
}());
